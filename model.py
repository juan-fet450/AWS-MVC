...
class Usuario(object):
       ...
       def setUsr(self, user_nm, passwd):
           ...
           try:
               cnx = mysql.connector.connect(user='Juan-fet', password='password2', database='db2',
                                             host='127.0.0.1')
               cursordb = cnx.cursor()
